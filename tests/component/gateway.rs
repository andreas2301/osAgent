...
//!
//! Tests public gateway infrastructure (rate limiter, idempotency) in
//! isolation. The gateway module (`zeroclaw::gateway`) exposes the server
//! function `run_gateway`, but the internal rate limiter and idempotency
//! store constructors are crate-private. Tests here verify behavior through
//! the public API surface.
//!
//! WhatsApp webhook signature tests were removed in Phase 1.5 when the
//! whatsapp-web channel was stripped.
