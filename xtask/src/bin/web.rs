...
//!   check    — `npx tsc -b` (typecheck without bundling).
//!
//! Note: gen-api was removed in Phase 1.6 when the gateway OpenAPI surface
//! was stripped. The web dashboard is now served from static files only.
//!
//! See #6175.
